...
let print_commands () : unit = 
  ...
  ANSITerminal.(print_string [blue] "Help: Displays more detailed instructions. \
                                     Can be called any time and progress maintainted.\n");
  ANSITerminal.(print_string [blue] "Back: Stops the current action and returns \
                                     to this screen. \n \n")
...
let print_help () : unit = 
  ...
  ANSITerminal.(print_string [black] "\n\nThis calendar application is written \
                                      in OCaml by Andrew Dircks and Samuel \
                                      Kantor.\n\n");
  ANSITerminal.(print_string [cyan; Bold] "Intended Use:\n");
  ANSITerminal.(print_string [black] "This calendar is designed for software \
                                      development teams using Git.\n");
  ANSITerminal.(print_string [black] "With this source code in a git repository, \
                                      team members can create and edit calendars,\
                                      \nwhich can be accessed, viewed, and \
                                      altered anywhere, automatically adaptive \
                                      to time zone. \n\n");
  ANSITerminal.(print_string [blue; Bold] "Overview:\n");
  ANSITerminal.(print_string [black] "Upon running 'make cal', the user can \
                                      input 'create' to make a new shared \
                                      calendar or 'access' to view/edit an \
                                      existing one.\n");
  ANSITerminal.(print_string [black] "Once a calendar is accessed, the user can\
                                      input the following commands:\n \n");

  ANSITerminal.(print_string [cyan; Bold] "Add:\n");
  ANSITerminal.(print_string [black] "The add command is responsible for \
                                      creating new events within the calendar.\n");
  ANSITerminal.(print_string [black] "Once called, the user is prompted to add \
                                      a NONEMPTY event name, that starts with a \
                                      character. Make this short and descriptive.\n");
  ANSITerminal.(print_string [black] "AVOID the names 'help' 'back' and 'all' \
                                      for events. \n");
  ANSITerminal.(print_string [black] "Then, a start date is required. The form\
                                      month/day/year/hour:minute/am(pm) is required.\n");
  ANSITerminal.(print_string [black] "The user will be told if an invalid format \
                                      or illegal date is entered. Events before \
                                      the day Jan 1, 2020 are not allowed.\n");
  ANSITerminal.(print_string [black] "Then, the event's duration must be entered \
                                      in hours or hours and minutes. \n");
  ANSITerminal.(print_string [black] "For example, entering '5' corresponds to 5 \
                                      hours, and entering '6:15' corresponds to \
                                      6 hours and 15 minutes. \n");
  ANSITerminal.(print_string [black] "After that, any description of the event \
                                      can be entered.\n");

  ANSITerminal.(print_string [cyan; Bold] "\nEdit:\n");
  ANSITerminal.(print_string [black] "The edit command is responsible for \
                                      editing existing events in the calendar.\n");
  ANSITerminal.(print_string [black] "Once called, the user is prompted to enter \
                                      the name of the event they would like to \
                                      edit. (case sensitive)\n");
  ANSITerminal.(print_string [black] "If this event does not exist, the user \
                                      will be reprompted.\n");
  ANSITerminal.(print_string [black] "If multiple events are found with the \
                                      same name, the application will display \
                                      the start times of each,\n");
  ANSITerminal.(print_string [black] "and the user will be required to choose \
                                      the entry to be edited.\n");
  ANSITerminal.(print_string [black] "The user must then enter 'name' 'start' \
                                      'end' or 'description' and update the \
                                      respective field. \n");

  ANSITerminal.(print_string [cyan; Bold] "\nDelete:\n");
  ANSITerminal.(print_string [black] "The delete command is responsible for \
                                      removing events in the calendar.\n");
  ANSITerminal.(print_string [black] "Once called, the user is prompted to enter \
                                      the name of the event they would like to \
  ...
  ANSITerminal.(print_string [cyan; Bold] "\nView:\n");
  ANSITerminal.(print_string [black] "The view command is responsible for \
                                      viewing your calendar!\n");
  ANSITerminal.(print_string [black] "Once called, the user has the choice for \
                                      three viewing options: a single event, a \
                                      week, or all events.\n");
  ANSITerminal.(print_string [black] "If you would like to view a single event, \
                                      simply enter the name of that event \
                                      (case sensitive).\n");
  ANSITerminal.(print_string [black] "Similar to 'edit' and 'delete', the \
                                      application handles the case of the event \
                                      not existing and/or multiple events \
                                      existing with that name.\n");
  ANSITerminal.(print_string [black] "If you would like to view a week, enter \
                                      the START date of that week in the \
                                      following formats: \n");
  ANSITerminal.(print_string [black; Bold] " 'dd' or 'mm/dd/' or 'mm/dd/yyyy'.\n");
  ANSITerminal.(print_string [black] "If only the day is entered (e.g. '5') then \
                                      the week starting on the user's current \
                                      year, month, with the entered day is shown. \n");
  ANSITerminal.(print_string [black] "If both the month and day are entered \
                                      (e.g. '3/12') then the week starting on \
                                      the user's current year, with the entered \
                                      day and month is shown. \n");
  ANSITerminal.(print_string [black] "If all three fields are entered (e.g. \
                                      '1/2/2020') then the week starting on \
                                      that day is entered. \n");
  ANSITerminal.(print_string [black] "If you would like to view all events \
                                      (sorted by start date), enter 'all'. \n");


  ANSITerminal.(print_string [cyan; Bold] "\nSave:\n");
  ANSITerminal.(print_string [black] "The save command saves the changes you \
                                      have made to the current calendar.\n");
  ANSITerminal.(print_string [black] "Make sure you call this command before \
                                      exiting, if you'd like to keep your \
                                      changes!.\n");

  ANSITerminal.(print_string [cyan; Bold] "\nExit:\n");
  ANSITerminal.(print_string [black] "The exit command exits the application \
                                      (does not save your progress).\n");

  ANSITerminal.(print_string [cyan; Bold] "\nBack:\n");
  ANSITerminal.(print_string [black] "The back command can be called at any time \
                                      during application use.\n");
  ANSITerminal.(print_string [black] "Upon call, the user is brought back to the\
                                      main instructions page.\n");
  ANSITerminal.(print_string [black] "Immedieate progress will be lost. For \
                                      example, if a user calls 'back' while \
                                      adding an event,.\n");
  ANSITerminal.(print_string [black] "the progress in that add command will \
                                      be lost.\n\n\n")
...
let print_success () = 
  ANSITerminal.(print_string [green] "Success! \n")
...
(** [print_InvalidDuration ()] displays invalid duration error message. *)
let print_InvalidDuration () = 
  ANSITerminal.(print_string [red] "That duration is not in the correct form. \
                                    Enter the integer number of hours, or \
                                    'hours:minutes'.\n")

(** [print_EventDNE ()] displays event does not exist error message. *)
let print_EventDNE () = 
  ANSITerminal.(print_string [red] "That event doesnt exist. Make sure you have\
                                    the correct event name.\n")

(** [print_invalidWeek ()] displays event invalid week error message. *)
let print_invalidWeek () = 
  ANSITerminal.(print_string [red] "Make sure the week you are trying to view \
                                    is in the following forms: \n");
  ANSITerminal.(print_string [black; Bold] " 'dd' or 'mm/dd/' or 'mm/dd/yyyy'.\n");
  ANSITerminal.(print_string [black] "For 'dd', the week that starts at the \
                                      entered day, the user's month, and the \
                                      user's year is viewed. \n");
  ANSITerminal.(print_string [black] "For 'mm/dd' the week that starts at the \
                                      entered month (mm) and day (dd) with the \
                                      user's year is viewed. \n");
  ANSITerminal.(print_string [black] "For 'mm/dd/yyyy' then the week starting \
                                      on that day is entered. \n")


(** [print_InvalidDateString ()] displays invalid date message. *)
let print_InvalidDateString () : unit = 
  ANSITerminal.(print_string [red; Bold] ("\nThe date you entered is not in the \
                                           correct form.\n"));
  ANSITerminal.(print_string [green] ("Make sure you enter a date in the form \
                                       'mm/dd/yyyy/hh:ii/xx where:' \n" 
                                      ^  "mm is the month in range [01..12]\n"
                                      ^  "dd is the day in range [01..31]\n"
                                      ^  "yyyy is the year in range [2020..]\n"
                                      ^  "hh is the hour in range [01..12]\n"
...
let print_CannotAddExisting () = 
  ANSITerminal.(print_string [red] "You cannot add an event with the same name \
                                    and start date as another event. Try again.\n")
...
let print_StartAfterEnd () = 
  ANSITerminal.(print_string [red] "Make sure the starting time is before the \
                                    end time!\n")

(** [print_InvalidField ()] displays error for an invalid field. *)
let print_InvalidField () = 
  ANSITerminal.(print_string [red] "Make sure you enter 'name' 'start' 'end' \
                                    or 'description'. \n")

(** [print_OutOfBounds ()] displays error for an invalid integer array index. *)
let print_OutOfBounds () = 
  ANSITerminal.(print_string [red] "Enter a valid integer from the list of \
                                    start times. \n")

(** [print_multiple_events ()] prints a message that multiple events with this 
    name exist. *)
let print_multiple_events () = 
  ANSITerminal.(print_string [green] "Multiple events with this name exist. \
                                      When does this event start? (enter the \
                                      number as labeled). \n")
...
let rec main_instructions disp calname = 
  ANSITerminal.(print_string [Bold] ("\nWhat would you like to do in calendar "
                                     ^ calname ^ "?\n"));
  if disp then print_commands ();
  Stdlib.print_string "Type here: > ";
  try read () |> main_parse 
  with 
  | CommandDNE -> print_CommandDNE (); main_instructions false calname
  | Back -> main_instructions false calname
  | Help -> main_instructions false calname

(** [event_name_instructions disp] prompts user for name of event. *)
let rec event_name_instructions disp = 
  if disp then ANSITerminal.(print_string [green] "What is the name of this event?\n");
  Stdlib.print_string "Type here: > ";
  try
    read () |> validate_name
  with 
...
let rec event_or_week_instructions () = 
  ANSITerminal.(print_string [green] "Enter the name on the event you would \
                                      like to view.\n");
  ANSITerminal.(print_string [green] "Or, enter the starting date of the week \
                                      you would like to view.\n");
  ANSITerminal.(print_string [green] "Or, enter 'all' to view all events.\n");
  Stdlib.print_string "Type here: > ";
...
let rec event_delete_edit_name_instructions action = 
  ANSITerminal.(print_string [green] ("What is the name of the event to " 
                                      ^ action ^ "?\n"));
  Stdlib.print_string "Type here: > ";
...
let rec start_time_instructions disp : Time.t = 
  if disp then ANSITerminal.(print_string [green] "When does this event start?\n");
  Stdlib.print_string "Type here: > ";
  try
...
let rec end_time_instructions start disp = 
  if disp then ANSITerminal.(print_string [green] "How long does this event \
                                                   last? (either enter a number \
                                                   of hours or hours:minutes)\n");
  Stdlib.print_string "Type here: > ";
  try 
  ...
  | InvalidDuration -> 
    print_InvalidDuration (); print_try_again (); end_time_instructions start false

(** [description_instructions ()] prompts user for event's description. *)
let rec description_instructions () = 
  ANSITerminal.(print_string [green] "What's this event's description?\n");
  Stdlib.print_string "Type here: > ";
  try read () with Help -> description_instructions ()

(** [field_instructions ()] prompts user for field to change. *)
let rec field_instructions () = 
  ANSITerminal.(print_string [green] "What do you want to edit - name, start, \
                                      end, or description?\n");
  Stdlib.print_string "Type here: > ";
  try read () |> ensure_valid_field with 
  | Help -> field_instructions ()
  | InvalidField -> print_InvalidField (); field_instructions ()

(** [field_edit_instructions field] prompts user for changed value of [field]*)
let rec field_edit_instructions field = 
  ANSITerminal.(print_string [green] ("What would you like to change the " 
                                      ^ field ^ " to?\n"));
  Stdlib.print_string "Type here: > ";
...
let rec create_instructions () : string =
  ANSITerminal.(print_string [green] ("What is the name of your new calendar? \
                                       Make sure you do not choose a name of \
...
let rec print_start_times es acc : unit = 
  ...
  | h::t -> ANSITerminal.(print_string [green] 
                            ((string_of_int acc) 
                             ^ ". " 
                             ^ (Graphic.to_display_time (h.starts |> Time.toLocal)) 
                             ^ "\n"));
...
let rec handle_multiple_events c name origin : Calendar.event = 
  try
    (match Calendar.find_event c name with 
     ...
     | None -> print_EventDNE (); 
       handle_multiple_events c (event_delete_edit_name_instructions origin) origin)
  with 
  | Help -> handle_multiple_events c name origin
  | Back -> raise Back
...
and edit_instructions c = 
  ...
  with 
  | InvalidDate -> 
    print_InvalidDate (); print_try_again (); edit_instructions c
  | MalformedList -> 
    print_MalformedList (); print_try_again (); edit_instructions c
  | EmptyEventName -> 
    print_EmptyEventName (); print_try_again (); edit_instructions c
  | StartAfterEnd -> 
    print_StartAfterEnd (); print_try_again (); edit_instructions c
  | InvalidDateString -> 
    print_InvalidDateString (); print_try_again (); edit_instructions c
  | EventDNE -> 
    print_EventDNE (); print_try_again (); edit_instructions c
  | InvalidField -> 
    print_InvalidField (); print_try_again (); edit_instructions c
  ...
  try 
    ...
    | Single es -> 
      (match es with 
       ...
       | _ -> 
         multiple_events_instructions es true |> Graphic.view_single; change false c )
    | Week t -> Graphic.view_week c t; change false c 
    | All -> Graphic.view_all c; change false c
  with
  | EventDNE -> 
    print_EventDNE (); print_try_again (); view_instructions c false
  | InvalidWeek -> 
    print_invalidWeek (); print_try_again (); view_instructions c false
  | InvalidDateString -> 
    print_InvalidDateString (); print_try_again (); view_instructions c false
  | Help -> view_instructions c true 
  | Back -> raise Back
...
and change (success : bool) (c : Calendar.t) : unit = 
  ...
  try
    match main_instructions true c.calname with  
  ...
  with 
  | CannotAddExisting -> 
    print_CannotAddExisting (); print_try_again (); change false c
...
let rec read_file () = 
  ...
  with 
    _ -> ANSITerminal.(print_string [red] "That calendar does not exist.\n"); 
    meta_instructions true

(** [meta_instructions disp] lists the highest level instructions *)
and meta_instructions disp = 
  if disp then ANSITerminal.(print_string [green] "Would you like to create a \
                                                   new calendar or access an \
                                                   existing one?\n");
  if disp then ANSITerminal.(print_string [green] "Enter 'create' or 'access'\n");
  Stdlib.print_string "Type here: > ";
  try 
